...
public class MenuDActivity extends AbstractCustomActivity {
    ...
    private void setButton(){
        ...
        entree3 = (RadioButton) findViewById(R.id.button_salade2);
        plat1 = (RadioButton) findViewById(R.id.button_viande2);
        plat2 = (RadioButton) findViewById(R.id.button_poisson2);
    ...
    public void validationMenu(View view) {
        ...
        if (plat1.isChecked())
            ...
            plat = getString(R.string.plat_poisson2);
        else
            allChecked = false;
        //String dessert
        ...
        if (allChecked) {
            String menu = getString(R.string.menuDshort);
            getCommande().addMenu(menu + "\n" + entree + "\n" + plat + "\n" + dessert);
            getCommande().ajoutMenuD(menu + "\n" + entree + "\n" + plat + "\n" + dessert);
